...
<div class="jshop productfull" id="comjshop">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 col-md-9 col-sm-9 col-xs-11">
                
                <?php if ($this->config->show_product_code){?> <span class="jshop_code_prod"><?php //print JText::_('JSHOP_EAN')?>Артикуль: <?php print $this->product->getEan();?></span><?php }?>
                <?php if(isset($this->product->product_old_price) && $this->product->product_old_price != null):?>
                    <div class="my_sale">
                        Скидка: 
                        <?php
                        $ch = $this->product->product_old_price - $this->product->getPriceCalculate();

                        echo intval($ch * 100 / $this->product->product_old_price)."%";
                        ?>
                    </div>
                <?php endif;?>    
                <?php include(dirname(__FILE__)."/ratingandhits.php");?>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-1 printer">
                <span onclick="window.print();"><i class="fa-solid fa-print"></i> Печать</span>
            </div>
            
            
        </div>
    </div>
    <h1 class="prod_name"><?php print $this->product->name?></h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-12 col-sm-9 col-xs-12">
                <ul class="nav nav-tabs header_tabs_prod" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="h-tab" data-bs-toggle="tab" data-bs-target="#h-tab-pane" type="button" role="tab" aria-controls="h-tab-pane" aria-selected="false">Характеристики</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="c-tab" data-bs-toggle="tab" data-bs-target="#c-tab-pane" type="button" role="tab" aria-controls="c-tab-pane" aria-selected="false">Сопутствующие товары</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="o-tab" data-bs-toggle="tab" data-bs-target="#o-tab-pane" type="button" role="tab" aria-controls="o-tab-pane" aria-selected="false"><span><?php echo $product->reviews_count; ?></span> Отзывы</button>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="h-tab-pane" role="tabpanel" aria-labelledby="h-tab" tabindex="0">
                        <div class="short_description">
                            <?php 
                                echo $this->product->short_description; 
                            ?>
                        </div>
                    ...
                    <div class="tab-pane fade" id="o-tab-pane" role="tabpanel" aria-labelledby="o-tab" tabindex="0">
            ...
            <div class="col-lg-3 col-md-12 col-sm-3 col-xs-12">
                <form name="product" method="post" action="<?php print $this->action?>" enctype="multipart/form-data" autocomplete="off" id="form_price">
                        ...
                        <div class="prod_buttons" style="<?php print $this->displaybuttons?>">
                            ...
                            <?php if ($this->config->product_show_qty_stock){?>
                                <div class="qty_in_stock">
                                    <?php //print JText::_('JSHOP_QTY_IN_STOCK')?>На складе:
